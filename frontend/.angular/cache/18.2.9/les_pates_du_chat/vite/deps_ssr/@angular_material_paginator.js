...
import {
  ...
  transition,
  trigger
} from "./chunk-LEWJ7YRR.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ScrollingModule,
  ViewportRuler
} from "./chunk-J3EBMMAL.js";
import {
  SelectionModel
} from "./chunk-3MMIEW3S.js";
import {
  MatButtonModule,
  MatIconButton
} from "./chunk-NVXEIIZX.js";
import {
  A,
  A11yModule,
...
var MatSelect = class _MatSelect {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _unusedNgZone, defaultErrorStateMatcher, _elementRef, _dir, parentForm, parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, _defaultOptions) {
    ...
    this.optionSelectionChanges = (0, import_rxjs4.defer)(() => {
      ...
      if (options) {
        return options.changes.pipe((0, import_operators4.startWith)(options), (0, import_operators4.switchMap)(() => (0, import_rxjs4.merge)(...options.map((option) => option.onSelectionChange))));
      }
      return this._initialized.pipe((0, import_operators4.switchMap)(() => this.optionSelectionChanges));
    });
    this.openedChange = new EventEmitter();
    this._openedStream = this.openedChange.pipe((0, import_operators4.filter)((o) => o), (0, import_operators4.map)(() => {
    }));
    this._closedStream = this.openedChange.pipe((0, import_operators4.filter)((o) => !o), (0, import_operators4.map)(() => {
    }));
  ...
  ngOnInit() {
    ...
    this.stateChanges.next();
    this._panelDoneAnimatingStream.pipe((0, import_operators4.distinctUntilChanged)(), (0, import_operators4.takeUntil)(this._destroy)).subscribe(() => this._panelDoneAnimating(this.panelOpen));
  ...
  _resetOptions() {
    ...
    (0, import_rxjs4.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators4.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
var MatTooltip = class _MatTooltip {
  ...
  constructor(_overlay, _elementRef, _scrollDispatcher, _viewContainerRef, _ngZone, _platform, _ariaDescriber, _focusMonitor, scrollStrategy, _dir, _defaultOptions, _document) {
    ...
    _dir.change.pipe((0, import_operators5.takeUntil)(this._destroyed)).subscribe(() => {
      if (this._overlayRef) {
        this._updatePosition(this._overlayRef);
      }
    });
...
var TooltipComponent = class _TooltipComponent {
  constructor(_changeDetectorRef, _elementRef, animationMode) {
    ...
    this._onHide = new import_rxjs5.Subject();
