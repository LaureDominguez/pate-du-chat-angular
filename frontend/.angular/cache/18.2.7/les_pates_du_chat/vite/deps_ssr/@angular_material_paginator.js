...
import {
  ...
  SelectionModel,
  ViewportRuler
} from "./chunk-WCXAWODA.js";
import {
  MatButtonModule,
  MatIconButton
} from "./chunk-LWUKKFDS.js";
import {
  animate,
  animateChild,
  query,
...
var AbstractControl = class {
  ...
  constructor(validators, asyncValidators) {
    ...
    this._events = new import_rxjs4.Subject();
...
var MatSelect = class _MatSelect {
  ...
  constructor(_viewportRuler, _changeDetectorRef, _unusedNgZone, defaultErrorStateMatcher, _elementRef, _dir, parentForm, parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, _defaultOptions) {
    ...
    this._destroy = new import_rxjs5.Subject();
    this.stateChanges = new import_rxjs5.Subject();
    ...
    this._panelDoneAnimatingStream = new import_rxjs5.Subject();
    ...
    this._initialized = new import_rxjs5.Subject();
    this.optionSelectionChanges = (0, import_rxjs5.defer)(() => {
...
var TooltipComponent = class _TooltipComponent {
  constructor(_changeDetectorRef, _elementRef, animationMode) {
    ...
    this._onHide = new import_rxjs6.Subject();
...
var MatPaginatorIntl = class _MatPaginatorIntl {
  constructor() {
    this.changes = new import_rxjs7.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  constructor(_intl, _changeDetectorRef, defaults) {
    ...
    this._isInitialized = false;
    this._initializedStream = new import_rxjs7.ReplaySubject(1);
    this._pageIndex = 0;
    this._length = 0;
